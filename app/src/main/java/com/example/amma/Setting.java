...
import com.example.amma.HomeActivity;
...
public class Setting extends AppCompatActivity
{
    ...
    private void updateOnlyUserInfo()
    {
        ...
        ref.child(Info.currentonuser.getPhone()).updateChildren(userMap);
    ...
    private void uploadImage()
    {
        ...
        if (imageUri != null)
        {
            final StorageReference fileRef = storageProfilePrictureRef
                    .child(Info.currentonuser.getPhone() + ".jpg");
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(Info.currentonuser.getPhone());
